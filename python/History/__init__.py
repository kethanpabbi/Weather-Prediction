...
def extract_monthly_data(data):
    ...
    for i in range(num_days):
        ...
        wanted_keys = ['date', 'maxtempC', 'mintempC','precipMM','humidity', 'totalSnow_cm'] # The keys you want
        ...
        col_to_keep = ['date_time', 'maxtempC', 'mintempC', 
                       'totalSnow_cm', 'moonrise', 'moonset', 
                       'sunrise', 'sunset', 'humidity', 'precipMM', 
